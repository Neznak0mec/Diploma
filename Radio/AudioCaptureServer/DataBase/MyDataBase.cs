...
public sealed class MyDataBase : DbContext
{
    ...
    public MyDataBase()
    {
        ...
        {
            connection =
                new NpgsqlConnection("Host=localhost;Port=5432;Database=radio;Username=user;Password=password");
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=radio;Username=user;Password=password");
    }
}